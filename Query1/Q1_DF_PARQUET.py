...
file_path1 = "hdfs://master:9000/home/user/ergasia_data/Crime_Data_from_2010_to_2019_parquet"
file_path2 = "hdfs://master:9000/home/user/ergasia_data/Crime_Data_from_2020_to_Present_parquet"
df1 = spark.read.parquet(file_path1)
df2 = spark.read.parquet(file_path2)

#Keep only 'DATE_OCC' and Combine the two datafames
